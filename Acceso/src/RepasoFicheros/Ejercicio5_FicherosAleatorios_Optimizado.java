...
public class Ejercicio5_FicherosAleatorios_Optimizado {
	...
	/***
	 * Escribe el contenido de todo el fichero (valores del 1 al 100) o modifica el
	 * valor de una posición determinada (ambos posición y nuevo valor se pasarán
	 * como parámetros) o añade un valor al final
	 * 
	 * @param valores si vacio, inicializa el fichero con valores del 1 al 100 si
	 *                tiene un único valor, se añade al final si tiene dos valores,
	 *                el primero el tomado como posición a sobreescribir con el
	 *                segundo
	 * @return si escribe todo, número de elementos escritos
	 * 
	 */
	 ...
	 * 
	 * @param lugar
	 * @return número de elementos leidos o el contenido en la posición indicada o
	 *         -1 si error
	 */
		...
		while (!salir) {
			...
			try {
				...
				case 4:
					...
					valor = sn.nextInt();
					System.out.println(escribir(posicion, valor) ? "Valor modificado correctamente"
